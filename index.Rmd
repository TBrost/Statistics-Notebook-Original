...
My stuff from work and other random commands; [link](https://docs.google.com/spreadsheets/d/1J-Pibv6gas9DyOgqtxZ3Ldkgu8oONocU40OECGXucdI/edit#gid=1937107222)

[Demos](https://shiny.byui.edu/content/1103/)
...
One sample T-tests, [one sample ttest](tTests.html#one-sample-t-test) are usually good to use here when data is normal and sample sizes are large. When dealing with non-parametric distributions or with very small (2-6) sample sizes a wilcoxon test is likely a better fit.
