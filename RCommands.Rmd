...
### "Not in" operator
To reverse the \%in\% operator you need to create a variation based off the existing function, unfortunately is not as easy as "!%in%". Simply paste the code below into your file and run it, now you can use %!in% to check for items "not" in a list.
...
Kids3 <- KidsFeet %>% 
  mutate(
    season = case_when(
      birthmonth %!in% c(12,1,2) ~ "Spring/Summer/Fall",
      birthmonth %in% c(12,1,2) ~ "Winter"
    )
  )
